...
export default function AddEditTask({ closeAddTask, onCreateTask }) {
  ...
  return (
    <>
      <div className="bg-black/70 h-full w-full absolute top-0 left-0" onClick={closeAddTask}>
      </div>
      <form
        className="mx-auto my-10 w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/36 bg-[#191D26] 
      p-9 max-md:px-4 lg:my-20 lg:p-11 z-10 absolute top-1/5 left-1/3"
      >
        <h2
